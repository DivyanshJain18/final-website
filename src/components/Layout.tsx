            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <nav aria-label="Shop Navigation">
                ...
                <ul className="space-y-2 text-sm">
                  <li><Link to="/pc-builder" aria-label="Build a Custom PC" className="text-electric-blue hover:text-cyan-400 font-bold transition-colors">Custom PC Builder</Link></li>
